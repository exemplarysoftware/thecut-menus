...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('menus_menuitem', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MenuItem.image'
        db.delete_column('menus_menuitem', 'image')
    ...
    models = {
        ...
        'menus.menuitem': {
            ...
            'is_enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'is_featured': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'menu': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'items'", 'to': "orm['menus.Menu']"}),
