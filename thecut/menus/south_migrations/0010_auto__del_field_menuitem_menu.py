...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'menus_menuitem', 'menu_id')


    def backwards(self, orm):
        # Adding field 'MenuItem.menu'
        db.add_column(u'menus_menuitem', 'menu',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'items', null=True, to=orm['menus.Menu'], blank=True),
                      keep_default=False)
