...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'menus_menuitem', 'menu_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['menus.Menu']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'MenuItem.menu'
        raise RuntimeError("Cannot reverse this migration. 'MenuItem.menu' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'MenuItem.menu'
        db.alter_column(u'menus_menuitem', 'menu_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['menus.Menu']))
