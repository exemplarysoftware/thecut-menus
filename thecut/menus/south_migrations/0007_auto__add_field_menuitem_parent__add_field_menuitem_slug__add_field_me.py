...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'menus_menuitem', 'parent',
                      self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name=u'children', null=True, to=orm['menus.MenuItem']),
                      keep_default=False)

        # Adding field 'MenuItem.slug'
        db.add_column(u'menus_menuitem', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MenuItem.lft'
        db.add_column(u'menus_menuitem', u'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'MenuItem.rght'
        db.add_column(u'menus_menuitem', u'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'MenuItem.tree_id'
        db.add_column(u'menus_menuitem', u'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'MenuItem.level'
        db.add_column(u'menus_menuitem', u'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'menus_menuitem', 'parent_id')

        # Deleting field 'MenuItem.slug'
        db.delete_column(u'menus_menuitem', 'slug')

        # Deleting field 'MenuItem.lft'
        db.delete_column(u'menus_menuitem', u'lft')

        # Deleting field 'MenuItem.rght'
        db.delete_column(u'menus_menuitem', u'rght')

        # Deleting field 'MenuItem.tree_id'
        db.delete_column(u'menus_menuitem', u'tree_id')

        # Deleting field 'MenuItem.level'
        db.delete_column(u'menus_menuitem', u'level')
    ...
    models = {
        ...
        u'menus.menuitem': {
            ...
            'menu': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'items'", 'to': u"orm['menus.Menu']"}),
